...
namespace OARMS.Core
{
    public partial class CommonHelper
    {
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new OarmsException("邮箱地址不是有效的！");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new OarmsException($"'{instanceType}'实例中没有发现 '{propertyName}' 属性");
            if (!pi.CanWrite)
                throw new OarmsException($"'{instanceType}'实例中属性'{propertyName}'没有setter方法");
        ...
        /// </summary>
        public static IOarmsFileProvider DefaultFileProvider { get; set; }
